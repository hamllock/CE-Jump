...
class Game:
    ...
    def updateScreen(self):
        ...
        enemies_hits=pygame.sprite.spritecollide(self.img_cechar,self.enemies,False, pygame.sprite.collide_mask)
        if enemies_hits:
            self.gameOver=True
        ...
        powerup_hits = pygame.sprite.spritecollide(self.img_cechar, self.powerups, False)
        for x in powerup_hits:
            self.pow_sound.play()
            self.vel.y = power_up_boost

        if self.vel.y > 0:
            hits = pygame.sprite.spritecollide(self.img_cechar, self.platforms, False)
            if hits:
                lowest = hits[0]
                for hit in hits:
    ...
    def startScreen(self):
        ...
        self.messageToScreen("CE JUMP", 40, white, display_width / 2, display_height / 4)
    ...
    def gameOverScreen(self):
        ...
        self.messageToScreen("Press any key to play again...", 30, black, display_width / 2 + 50, display_height / 2 + 50)
